...
(function($) {
	...
	$.fn.poshytip.defaults = {
		...
		showAniDuration: 	150,		// show animation duration - set to 0 if you don't want show animation
		hideAniDuration: 	150		// hide animation duration - set to 0 if you don't want hide animation
	};
